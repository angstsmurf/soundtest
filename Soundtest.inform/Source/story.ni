...
[ Basic_autotest res;
	...
	else
	{
		...
		if (glk_gestalt(gestalt_SoundNotify, 0))
		{
			...
			print "^^When the AIFF stops playing, a sound notification message should be printed ([Sound notification 2 for sound resource id 3 (the AIFF).]). Not if you press a button before it has finished, though.";
			notify_expected = 1;
